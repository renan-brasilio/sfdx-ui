<script>
    ...
    function test_run() {
        tsvscode.postMessage({
            type: "onInfo",
            value: "Starting the Terminal + Script: Test:Run" 
        });
        ...
        message.sfdx = "force:apex:test:run";
...
{#if $mapSpinner.force.test_run}
    <div class="sfdxet-spinner">
        <Circle2 size="60" colorOuter="#034efc" unit="px"></Circle2>
    </div>
{:else}
    <div class="sfdxet-absolute-center">
        <h3>sfdx force:apex:test:run</h3>
        <br/>
        <br/>
        <button class="sfdxet-buttons" on:click={test_run}>Test:Run</button>
        <br/>
        <br/>
        <h3>Options:</h3>
        <h4><a target="_blank" href="https://developer.salesforce.com/docs/atlas.en-us.sfdx_cli_reference.meta/sfdx_cli_reference/cli_reference_force_apex.htm#cli_reference_force_apex_test_run">Official Documentation</a></h4>
        <br/>
